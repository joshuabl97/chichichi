...
I've modified the example for this gophercises exercise to use the Chi router instead of Gorilla Mux. 

Currently the program accepts JSON in the form of a flag and will redirect localhost:8080/{endpoint} to any endpoint specified in the JSON

`go run main.go -json='[{"url":"https://google.com","endpoint":"example1"},{"url":"https://example.org","endpoint":"example2"}]'`
